...
<hr />
    ...
    <p><b>Email : </b><?= !empty($author['FAC_email']) ? htmlentities($author['FAC_email']) : '<i>aucun mail renseigne</i>'?><br />
    <hr />
...
<?php
    ...
    {
    ?>
    <h3 id="news-header" class="detail-news-header"><?= htmlentities($news['FNC_title']) ?></h3>
...
foreach($comment_author_a as $comment)
{
    ...
    <p id="comment-content" class="detail-comment-content"><?= nl2br(htmlentities($comment['FCC_content'])) ?></p>
    <?php
}
?>
</body>
